...
function theme_moove_get_extra_scss($theme) {
    ...
    // Restore the legacy centered login background for non split-screen login templates.
    $content .= 'body.pagelayout-login #page { ';
    $content .= "background-color: initial; background-image: url('$loginbackgroundimageurl'); background-size: cover;";
    $content .= ' }';
