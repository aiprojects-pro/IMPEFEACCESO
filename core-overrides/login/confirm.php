...
if (!empty($data) || (!empty($p) && !empty($s))) {
    ...
    if ($confirmed == AUTH_CONFIRM_ALREADY) {
        ...
        // A newly confirmed user may have arrived from a course preview. They must first
        // complete the access-accreditation process, so do not send them back to that course.
        unset($SESSION->wantsurl);
